...
Pets: TypeAlias = Annotated[List[Pet], Field(max_length=10, min_length=1)]


UID: TypeAlias = Annotated[int, Field(ge=0)]


Phone: TypeAlias = Annotated[str, Field(min_length=3)]


FaxItem: TypeAlias = Annotated[str, Field(min_length=3)]
