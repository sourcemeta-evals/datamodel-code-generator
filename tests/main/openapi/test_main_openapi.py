...
def test_main_openapi_discriminator_allof(output_file: Path) -> None:
    ...
    When a parent schema has a discriminator with mapping, and child schemas
    use allOf to extend the parent, the discriminator field should be set
    to a Literal type with the mapped value.
    """
    run_main_and_assert(
