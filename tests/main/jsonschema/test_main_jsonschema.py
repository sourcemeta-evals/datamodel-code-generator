...
def test_main_jsonschema_x_property_names_with_pattern_properties(output_file: Path) -> None:
    """Test x-propertyNames combined with x-patternProperties."""
    run_main_and_assert(
        input_path=JSON_SCHEMA_DATA_PATH / "x_property_names_with_pattern_properties.json",
        output_path=output_file,
        input_file_type="jsonschema",
        assert_func=assert_file_content,
        expected_file="x_property_names_with_pattern_properties.py",
    )
