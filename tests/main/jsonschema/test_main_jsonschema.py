...
@pytest.mark.parametrize(
    ("output_model", "target_python_version", "extra_args", "expected_output"),
    [
        (
            "pydantic.BaseModel",
            "3.9",
            [],
            "use_type_alias_pydantic_v1.py",
        ),
        (
            "pydantic_v2.BaseModel",
            "3.9",
            ["--use-annotated"],
            "use_type_alias_pydantic_v2_py39.py",
        ),
        (
            "pydantic_v2.BaseModel",
            "3.12",
            ["--use-annotated"],
            "use_type_alias_pydantic_v2_py312.py",
        ),
    ],
)
@freeze_time("2019-07-26")
def test_main_jsonschema_use_type_alias(
    output_model: str,
