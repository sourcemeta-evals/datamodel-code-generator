...
def test_main_use_type_alias_pydantic_v2_py39(tmp_path: Path) -> None:
    ...
    return_code: Exit = main([
        "--input",
        str(JSON_SCHEMA_DATA_PATH / "use_type_alias.json"),
        "--output",
        str(output_file),
        "--input-file-type",
        "jsonschema",
    ...
    assert (
        output_file.read_text(encoding="utf-8")
        == (EXPECTED_JSON_SCHEMA_PATH / "use_type_alias_pv2_py39.py").read_text()
    )
...
def test_main_use_type_alias_pydantic_v2_py312(tmp_path: Path) -> None:
    ...
    assert (
        output_file.read_text(encoding="utf-8")
        == (EXPECTED_JSON_SCHEMA_PATH / "use_type_alias_pv2_py312.py").read_text()
    )
...
def test_main_use_type_alias_pydantic_v1_py39(tmp_path: Path) -> None:
    ...
    assert (
        output_file.read_text(encoding="utf-8")
        == (EXPECTED_JSON_SCHEMA_PATH / "use_type_alias_pv1_py39.py").read_text()
    )


@freeze_time("2019-07-26")
def test_main_use_type_alias_dataclass_py39(tmp_path: Path) -> None:
    output_file: Path = tmp_path / "output.py"
    return_code: Exit = main([
        "--input",
        str(JSON_SCHEMA_DATA_PATH / "use_type_alias.json"),
    ...
    assert (
        output_file.read_text(encoding="utf-8")
        == (EXPECTED_JSON_SCHEMA_PATH / "use_type_alias_dataclass_py39.py").read_text()
    )


@freeze_time("2019-07-26")
def test_main_use_type_alias_typed_dict_py39(tmp_path: Path) -> None:
    output_file: Path = tmp_path / "output.py"
    return_code: Exit = main([
        "--input",
        str(JSON_SCHEMA_DATA_PATH / "use_type_alias.json"),
    ...
    assert (
        output_file.read_text(encoding="utf-8")
        == (EXPECTED_JSON_SCHEMA_PATH / "use_type_alias_typed_dict_py39.py").read_text()
    )
