...
def test_jsonschema_x_pattern_properties(output_file: Path) -> None:
    """Test x-patternProperties extension for OpenAPI 3.0."""
    run_main_and_assert(
...
def test_jsonschema_x_property_names(output_file: Path) -> None:
    """Test x-propertyNames extension with additionalProperties."""
    run_main_and_assert(
...
def test_jsonschema_x_property_names_only(output_file: Path) -> None:
    """Test x-propertyNames extension without additionalProperties."""
    run_main_and_assert(
        input_path=JSON_SCHEMA_DATA_PATH / "x_property_names_only.json",
        output_path=output_file,
        input_file_type="jsonschema",
        assert_func=assert_file_content,
        expected_file="x_property_names_only.py",
    )
