...
def test_main_jsonschema_oneof_const_enum_inline(output_file: Path) -> None:
    """Test inline oneOf with const values (in properties) generates an enum class."""
    run_main_and_assert(
        input_path=JSON_SCHEMA_DATA_PATH / "oneof_const_enum_inline.json",
        output_path=output_file,
        input_file_type="jsonschema",
        assert_func=assert_file_content,
        expected_file="oneof_const_enum_inline.py",
    )
