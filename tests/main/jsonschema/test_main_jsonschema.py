...
def test_main_jsonschema_x_property_names(output_file: Path) -> None:
    """Test x-propertyNames extension maps to propertyNames and constrains dict keys."""
    run_main_and_assert(
...
def test_main_jsonschema_x_pattern_properties(output_file: Path) -> None:
    """Test x-patternProperties extension maps to patternProperties."""
    run_main_and_assert(
...
def test_main_jsonschema_x_pattern_properties_with_property_names(output_file: Path) -> None:
    """Test x-patternProperties combined with x-propertyNames uses propertyNames pattern for dict key."""
    run_main_and_assert(
        input_path=JSON_SCHEMA_DATA_PATH / "x_pattern_properties_with_property_names.json",
        output_path=output_file,
        input_file_type="jsonschema",
        assert_func=assert_file_content,
        expected_file="x_pattern_properties_with_property_names.py",
    )
