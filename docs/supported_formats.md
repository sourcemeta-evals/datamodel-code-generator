...
| `$recursiveRef/$recursiveAnchor` | 2019-09 | ⚠️ Partial | Static local anchor resolution only, not full runtime dynamic scope |
| `$dynamicRef/$dynamicAnchor` | 2020-12 | ⚠️ Partial | Static local anchor resolution only, not full runtime dynamic scope across arbitrary resources |
...
| `$recursiveRef` / `$recursiveAnchor` | 2019-09 | ⚠️ Partial | Statically resolved to self-reference, not full runtime dynamic scope |
| `$dynamicRef` / `$dynamicAnchor` | 2020-12 | ⚠️ Partial | Statically resolved to self-reference, not full runtime dynamic scope across arbitrary resources |
