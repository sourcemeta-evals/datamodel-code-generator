...
def _get_type_alias_root_model(
    ...
    is_py39 = target_python_version == PythonVersion.PY_39

    # Python 3.12+: always use native `type` statement
    ...
    # All others (Pydantic v1, dataclass, TypedDict, msgspec) + Python 3.9-3.11:
