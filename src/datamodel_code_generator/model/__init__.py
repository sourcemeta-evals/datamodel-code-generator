...
def get_data_model_types(
    ...
    *,
    ...
    if data_model_type == DataModelType.PydanticV2BaseModel:
        root_model = pydantic_v2.TypeAliasModel if use_annotated_type_alias else pydantic_v2.RootModel
        return DataModelSet(
            data_model=pydantic_v2.BaseModel,
            root_model=root_model,
            field_model=pydantic_v2.DataModelField,
            data_type_manager=pydantic_v2.DataTypeManager,
            dump_resolve_reference_action=None if use_annotated_type_alias else pydantic_v2.dump_resolve_reference_action,
        )
