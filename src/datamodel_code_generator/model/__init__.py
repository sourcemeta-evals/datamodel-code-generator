...
def _get_type_alias_root_model(
    ...
    from .type_alias import (  # noqa: PLC0415
        TypeAliasAnnotationModel,
        TypeAliasAnnotationModelPy39,
        TypeAliasTypeModel,
        TypeStatementModel,
    )
    ...
    if target_python_version.has_type_alias_in_typing:
        return TypeAliasAnnotationModel
    return TypeAliasAnnotationModelPy39
