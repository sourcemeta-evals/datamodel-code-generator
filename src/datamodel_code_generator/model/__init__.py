...
def get_data_model_types(
    ...
    from .type_alias import create_type_alias_model_class  # noqa: PLC0415
    from .types import DataTypeManager  # noqa: PLC0415

    if data_model_type == DataModelType.PydanticBaseModel:
        type_alias_model = create_type_alias_model_class(target_python_version, use_pydantic_v2=False)
        return DataModelSet(
    ...
    if data_model_type == DataModelType.PydanticV2BaseModel:
        type_alias_model = create_type_alias_model_class(target_python_version, use_pydantic_v2=True)
        return DataModelSet(
