...
def get_data_model_types(
    ...
    if data_model_type == DataModelType.PydanticBaseModel:
        return DataModelSet(
            ...
            root_model=pydantic.TypeAliasRootType if use_type_alias else pydantic.CustomRootType,
    ...
    if data_model_type == DataModelType.PydanticV2BaseModel:
        return DataModelSet(
            ...
            root_model=pydantic_v2.TypeAliasRootModelPydanticV2 if use_type_alias else pydantic_v2.RootModel,
    ...
    if data_model_type == DataModelType.DataclassesDataclass:
        return DataModelSet(
            ...
            root_model=rootmodel.TypeAliasRootModel if use_type_alias else rootmodel.RootModel,
    ...
    if data_model_type == DataModelType.MsgspecStruct:
        return DataModelSet(
            ...
            root_model=rootmodel.TypeAliasRootModel if use_type_alias else msgspec.RootModel,
