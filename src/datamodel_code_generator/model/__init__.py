...
def get_data_model_types(
    ...
    *,
    ...
    from .type_alias import get_type_alias_data_model  # noqa: PLC0415
    from .types import DataTypeManager  # noqa: PLC0415

    root_model_type = get_type_alias_data_model(data_model_type, target_python_version) if use_type_alias else None

    if data_model_type == DataModelType.PydanticBaseModel:
        return DataModelSet(
            data_model=pydantic.BaseModel,
            root_model=root_model_type or pydantic.CustomRootType,
    ...
    if data_model_type == DataModelType.PydanticV2BaseModel:
        return DataModelSet(
            ...
            root_model=root_model_type or pydantic_v2.RootModel,
    ...
    if data_model_type == DataModelType.DataclassesDataclass:
        return DataModelSet(
            ...
            root_model=root_model_type or rootmodel.RootModel,
    ...
    if data_model_type == DataModelType.MsgspecStruct:
        return DataModelSet(
            ...
            root_model=root_model_type or msgspec.RootModel,
