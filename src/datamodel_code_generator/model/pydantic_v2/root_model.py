...
from datamodel_code_generator.model.rootmodel import TypeAliasRootModel
...
class TypeAliasRootModelPydanticV2(TypeAliasRootModel):
    TYPE_ALIAS_KIND: ClassVar[str] = "pydantic_v2"
