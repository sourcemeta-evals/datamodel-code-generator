...
class JsonSchemaParser(Parser):
    ...
    def set_discriminator(self, path: str, obj: JsonSchemaObject) -> None:
        """Set discriminator in extra template data for later post-processing."""
        if isinstance(obj.discriminator, Discriminator):
            self.extra_template_data[path]["discriminator"] = obj.discriminator.dict(exclude_unset=True)
