...
typing_options.add_argument(
    ...
    "Uses native `type` statement for Python 3.12+, TypeAliasType for Pydantic v2 with Python 3.9-3.11, "
    "and TypeAlias annotation for Pydantic v1 and non-Pydantic output types.",
    action="store_true",
    default=None,
)
