...
model_options.add_argument(
    ...
    action="store_true",
    default=None,
    help="Generate type aliases instead of RootModel classes. Uses native `type` statement for Python 3.12+, "
    "TypeAliasType for Pydantic v2 with Python 3.9-3.11, and TypeAlias annotation for Pydantic v1 or non-Pydantic output types",
)
model_options.add_argument(
