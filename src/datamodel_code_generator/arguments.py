...
typing_options.add_argument(
    ...
    "Uses `type` statement for Python 3.12+, TypeAliasType for Pydantic v2 on Python 3.9-3.11, "
    "and TypeAlias annotation for Pydantic v1 and other output types on Python 3.9-3.11.",
    action="store_true",
    default=None,
)
typing_options.add_argument(
